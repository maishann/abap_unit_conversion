...
DATA lv_price_local TYPE p LENGTH 6 DECIMALS 2.
DATA gt_out         TYPE STANDARD TABLE OF zco_convert_unit_alv.
...
START-OF-SELECTION.
  ...
  CALL FUNCTION 'CONVERT_TO_LOCAL_CURRENCY'
    EXPORTING  client           = sy-mandt
               ...
               type_of_rate     = 'M'
               read_tcurr       = 'X'
    IMPORTING  exchange_rate    = <ls_out>-exchange_rate
...
FORM show_alv.
  ...
  gr_cont = NEW #( container_name = 'CONTAINER' ).
...
*                                                   ir_salv_adapter               = " Interface ALV Adapter
                                        CHANGING   it_outtab                     = gt_out           " Ausgabetabelle
